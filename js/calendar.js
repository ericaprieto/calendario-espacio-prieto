function BookingCalendar(div, ocupiedDates) {
  ...
  function _drawCal(firstDay, lastDate) {
    ...
    text +=
      '<h2><button onclick="calendar.prev()"><span>‹‹</span></button> <span class="title">' +
      monthName +
      " " +
      currentYear +
      '</span> <button onclick="calendar.next()"><span>››</span></button></h2>';
